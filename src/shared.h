...
#define BUFFER_INITIALIZER ((struct test){.pitch = 440, .volume = 0.0,.waveform = SIN,.len = 0,.mutex = PTHREAD_MUTEX_INITIALIZER,.can_produce = PTHREAD_COND_INITIALIZER,.can_consume = PTHREAD_COND_INITIALIZER})
